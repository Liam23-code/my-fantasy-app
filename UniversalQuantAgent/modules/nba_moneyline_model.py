...
def _apply_team_status_penalty(
    ...
    so this is a pure opt-in seam over an otherwise team-history model with no
    player inputs -- mirrors ``betting.moneyline_model`` for NFL exactly."""
...
def evaluate_game(
    ...
    *,
    ...
    :func:`fantasy.multi_sport_status.team_status_penalty`) that shades a team's
    projection for unavailable key players. Omit it for the exact historical
    behaviour.
    """
