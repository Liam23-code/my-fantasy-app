"""CBB game odds (moneyline/spread/total): our own default file plus user uploads.
...
DEFAULT_GAME_ODDS_PATH = DATA_ROOT / "cbb_game_odds.json"
...
def load_default_game_odds(path: str | Path | None = None) -> dict[str, Any]:
    """Load our default CBB game-odds file (default: ``data/cbb_game_odds.json``).
...
def load_uploaded_game_odds(source: Any, *, file_format: str | None = None) -> dict[str, Any]:
    """Parse a user-uploaded CBB game-odds file: JSON, CSV, or delimited text."""
...
def unified_game_odds(
    *, default_path: str | Path | None = None, uploaded: Any = None, uploaded_format: str | None = None
    ...
    """Our default CBB game odds, optionally merged with an uploaded override."""
