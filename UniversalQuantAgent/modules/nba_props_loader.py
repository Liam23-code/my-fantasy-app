...
#: The default file changes at most once a season (regenerated by
#: modules/nba_props_generator.py) -- a few minutes of caching avoids
#: re-parsing a ~200KB JSON file on every prop evaluation within a page
#: render, at the cost of at most this much staleness after a regeneration.
