...
# Props, Parlays -- for College Basketball only. One of six sport-
...
render_multi_sport_status_strip(
    "CBB",
    "cbb_betting_refresh_player_status",
...
# One badge per priced player. Live-OUT players are already dropped by the CBB
...
with st.expander("Player availability"):
    ...
    for _row in cbb_prop_evaluations:
